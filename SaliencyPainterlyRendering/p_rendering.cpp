...
*/
	int render_::P_Rendering(Mat & _src_ROI_canvas, Mat & _before_ROI_canvas, cv::Mat & _changed_ROI_clone, 
		cv::Mat & ing_ROI, Point _fetch_color_Point, Point centered_SrtPoint, Point canvas_centered_SrtPoint, Point canvas_centered_EndPoint, int brush_area_w_size, int brush_area_h_size, int astroke_depth, int painting_count, int color_BGR_B, int color_BGR_G, int color_BGR_R)
